...
export const applications: Application[] = [
  {
    ...
    team: 'Claims',
    description: 'Reviews inbound claims packets before payout.',
    framework: 'langchain',
    runtime: 'python3.12',
    tools: ['create_purchase_order'],
    capabilities: ['review'],
    mcp_servers: [{ name: 'policy-docs', url: 'http://127.0.0.1:3100', tools: ['search'] }],
    observed_tools: ['create_purchase_order'],
  },
  {
    app_id: 'app-2',
    name: 'Staging Bot',
